...
echo -e "$COLOR1│$NC${WH}❈ CORE & CPU      : ${WH}$CORE GB & $cpu_usage${NC}"
echo -e "$COLOR1│$NC${WH}❈ MEMORY RAM      : ${WH}$uram - $tram${NC}"
echo -e "$COLOR1│$NC${WH}❈ UPTIME          : ${WH}$SERONLINE${NC}"
echo -e "$COLOR1│$NC${WH}❈ IP VPS          : ${WH}$(curl -s ipv4.icanhazip.com)${NC}"
...
echo -e "   $COLOR1      ───────────────────────────────── ${NC}"
echo -e "$COLOR1     │     $NC${WH} SSH/OPENVPN    :     ${COLOR1}$total_ssh      ${NC}" 
echo -e "$COLOR1     │     $NC${WH} VLESS          :     ${COLOR1}$vless          ${NC}" 
echo -e "$COLOR1     │     $NC${WH} VMESS          :     ${COLOR1}$vmess          ${NC}" 
echo -e "$COLOR1     │     $NC${WH} TROJAN         :     ${COLOR1}$trtls          ${NC}"    
echo -e "$COLOR1     └───────────────────────────────────────┘${NC}"

echo -e "$COLOR1   ┌───────────────────────────────────────────┐${NC}"
echo -e "$COLOR1   │$NC ${WH} Version       ${COLOR1}: ${WH}$(cat /opt/.ver) Latest Version${NC}$COLOR1"
echo -e "$COLOR1   │$NC ${WH} Order by      ${COLOR1}: ${WH}SFVpn TUNNELING${NC}$COLOR1"
echo -e "$COLOR1   │$NC ${WH} Client name   ${COLOR1}: ${WH}$client_name${NC}"
echo -e "$COLOR1   │$NC ${WH} Sisa Hari     ${COLOR1}: ${WH}$days_remaining hari${NC}"
echo -e "$COLOR1   │$NC ${WH} Expiry in     ${COLOR1}: ${WH}$exp_date${NC}"
echo -e "$COLOR1   └───────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│ $NC \e[92m1.)\e[93m☞ ${WH} SSH          $NC \e[92m6.)\e[93m☞ ${WH} RESTART           $COLOR1 │ $NC"
echo -e "$COLOR1  $NC \e[92m2.)\e[93m☞ ${WH} VMESS        $NC \e[92m7.)\e[93m☞ ${WH} UPDATE SCRIPT     $NC"
echo -e "$COLOR1│ $NC \e[92m3.)\e[93m☞ ${WH} VLESS        $NC \e[92m8.)\e[93m☞ ${WH} BACKUP RESTORE    $COLOR1 │ $NC"
echo -e "$COLOR1  $NC \e[92m4.)\e[93m☞ ${WH} TROJAN       $NC \e[92m9.)\e[93m☞ ${WH} SETTING           $NC"
echo -e "$COLOR1│ $NC \e[92m5.)\e[93m☞ ${WH} RUNNING      $NC \e[92mx.)\e[93m☞ ${WH} EXIT              $COLOR1 │ $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
...
03 | 3) clear ; m-vless ;;
04 | 4) clear ; m-trojan ;;
05 | 5) clear ; skt-cekservice ;;
06 | 6) clear ; skt-running ;;
07 | 7) clear ; m-update ;;
08 | 8) clear ; skt-menu-backup ;;
09 | 9) clear ; skt-system ;;
X | x) clear ; exit ;;
*) clear ; menu ;;
esac
